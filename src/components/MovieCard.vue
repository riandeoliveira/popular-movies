...
import { useMovieStore, type Movie } from "../stores/use-movie-store";
    ...
    <div class="flex gap-6 max-s-720:flex-col">
      ...
      >
        ...
        >
          ...
          <span v-if="!!!props.release_date">&nbsp;(????)</span>
          <span v-else>&nbsp;({{ props.release_date.slice(0, 4) }})</span>
        </a>
        <div class="flex justify-between">
          <div class="flex gap-3 items-center">
            ...
            <span
              v-if="
                props.vote_average !== null && props.vote_average !== undefined
              "
            >
          ...
          <div class="flex gap-3 items-center">
            ...
            >
              <HeartIcon :class="props.favorite ? 'fill-c-red-700' : ''" />
            </button>
            <label
              tabindex="0"
              @click="movieStore.handleFavoriteMovie(props)"
